...
const noCopyResult = optimizer.optimize(fakeDsl(), constraints, 1080, 1920, undefined, undefined);
...
const withCopyResult = optimizer.optimize(fakeDsl(), constraints, 1080, 1920, undefined, { headline: longHeadline, subheadline });
...
const shortCopyResult = optimizer.optimize(fakeDsl(), constraints, 1080, 1920, undefined, { headline: 'GLOW', subheadline: 'Simple.' });
